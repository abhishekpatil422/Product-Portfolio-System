...
<html lang="en">
   <head>
      <!-- START META TAGS-->
      <meta name="title" content="404 | RapidToolings">
...
<!-- START COOKIE-ALERT -->
  ...
  grecaptcha.ready(function() {
      grecaptcha.execute('6LeJDOYUAAAAALl2KoI7meK6IZk2n8xsTGRowLcO', {action: 'AboutUs'}).then(function(token) {
